                ...
                >
                  <div className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 self-end sm:self-center shrink-0">
                      ...
                      >
                        {copiedErrorId === report.id ? <Check size={14} /> : <Copy size={14} />}
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <button
                            type="button"
                            onClick={() => handleCopyError(report)}
                            className="px-2 py-1 rounded bg-slate-800 hover:bg-slate-700 text-xs text-slate-300 hover:text-white flex items-center gap-1 cursor-pointer transition-colors"
                          >
