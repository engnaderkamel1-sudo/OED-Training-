...
import { Activity, RefreshCw, Loader2, MapPin, Search, PlusCircle, X, Users, History } from 'lucide-react';
...
export const ActivityLogsView: React.FC = () => {
  ...
  return (
    <div 
      className="rounded-2xl shadow-md border overflow-hidden animate-fadeIn transition-colors"
      style={{ 
