...
export const isSessionActiveNow = (session?: UpcomingSession | null): boolean => {
  ...
  // Strictly active only between start time and 4:00 PM
  return currentTotalMinutes >= startTotalMinutes && currentTotalMinutes < endTotalMinutes;
};

/**
 * Trigger Native Browser & Mobile OS Push Notification
 */
export const sendNativePushNotification = async (title: string, options?: NotificationOptions) => {
