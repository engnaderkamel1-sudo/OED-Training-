        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              {/* صندوق بحجم ثابت عشان الشريط ميتأثرش لما اللوجو يتحرك */}
              <div className="w-10 h-10 flex-shrink-0">
                <AnimatePresence>
                  {!isLogoExpanded && (
                    <motion.img 
                      layoutId="main-app-logo"
                      src="/app-icon.jpg" 
                      alt="OED-TTMS" 
      ...
      <AnimatePresence>
        {isLogoExpanded && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[999999] bg-black/70 backdrop-blur-sm flex items-center justify-center cursor-pointer"
          ...
          >
            <motion.img
              ...
              onClick={(e) => {
                // منع التكبير من الاختفاء لو ضغط على اللوجو نفسه وهو كبير (اختياري)
                e.stopPropagation();
